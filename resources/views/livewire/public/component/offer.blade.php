      ...
      <div class="bg-gradient-to-r from-[#2e716b] to-[#3a8a82] rounded-lg shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-500">
        <div class="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div class="p-8 lg:p-12 text-[#2e716b]">
            <h2 class="text-4xl sm:text-5xl  mb-6 animate__animated animate__fadeInDown">Flash Sale!</h2>
            ...
            <div class="flex items-center mb-6 animate__animated animate__fadeIn animate__delay-2s">
              <span class="text-5xl ">Up to 50% OFF</span>
              <span class="ml-4 text-2xl line-through opacity-75">₹100</span>
              <span class="ml-4 text-2xl ">Now ₹50</span>
            </div>
            <!-- Countdown Timer -->
          ...
          <div class="lg:block">
            <img
              src="sell.jpeg"
              alt="Special Offer"
              class="w-full h-64 lg:h-full object-cover transform hover:scale-110 transition-transform duration-500"
            />
          </div>
        </div>
      </div>
