<div>
  ...
  <style>
    ...
    .animate-scroll {
      display: flex;
      width: 200%; /* Double the width for infinite scroll effect */
    ...
    /* Ensure only 4 cards are visible at a time */
    .relative {
      width: 100%;
      overflow: hidden;
    }
    ...
    .animate-scroll > div {
      flex: 0 0 calc(25% - 2rem); /* Each card takes 25% width minus the gap */
      max-width: calc(15% - 2rem); /* Limit card width */
    ...
    @media (max-width: 1024px) {
      .animate-scroll > div {
        flex: 0 0 calc(33.33% - 2rem); /* Show 3 cards on tablets */
    ...
    @media (max-width: 768px) {
      .animate-scroll > div {
        flex: 0 0 calc(50% - 2rem); /* Show 2 cards on smaller tablets */
    ...
    @media (max-width: 480px) {
      .animate-scroll > div {
        flex: 0 0 calc(100% - 2rem); /* Show 1 card on mobile */
        max-width: calc(50% - 2rem);
      }
    }
  </style>
