    ...
    <div class="max-w-lg mx-auto mt-10 bg-white p-6">
        <form wire:submit.prevent="update">
            <div class="p-5 bg-gray-50 border border-gray-200">
                ...
                @if($isEditing)
                <div>
                    <input type="text" wire:model.live="discount_price" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7db0ad] hover:border-[#7db0ad] transition-all" placeholder="Enter new product discountprice">
